...
if __name__ == '__main__':
    ...
    for seed in tqdm(range(0, 10)):
        ...
        # Solver
        of_exact, sol_exact, sol_q, comp_time_exact, flagSolver = prb.solve(dict_data, verbose=False, time_limit=30*60)
        ...
        file_output = open("./results/exp_general_table_6.csv", "a")
        file_output.write(f"{seed},{sim_setting['antenna_row']},{sim_setting['antenna_column']},{'solver'},{-1},{comp_time_exact},{of_exact},{flagSolver}\n")
