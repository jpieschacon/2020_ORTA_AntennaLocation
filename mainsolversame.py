...
if __name__ == '__main__':
    ...
    for itervalue in tqdm(range(0, 100)):
        ...
        for seed in tqdm(range(0, 30)):
            ...
            file_output = open("./results/exp_general_table_iter_same_solver6_BIC.csv", "a")
            ...
            file_output.write(f"{seed},{sim_setting['antenna_row']},{sim_setting['antenna_column']},{'BIC'},{iter_number},{comp_time_heu_bic},{of_heu_bic},{-1}\n")
